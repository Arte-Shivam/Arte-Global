  ...
  return (
    <div className="min-h-screen flex items-center justify-center section-padding relative">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md bg-white rounded-2xl border border-border/50 p-8 shadow-lg"
      >
        <div className="text-center mb-8">
          <Link to="/">
            <img src="/logo.svg" alt="Arte Recruitment" className="h-10 mx-auto mb-4" />
          </Link>
          <h3>Login to Arte Recruitment</h3>
          <p className="text-sm mt-2 text-accent/60">
            Signing in as {role === 'recruiter' ? 'Recruiter' : 'Candidate'}
          </p>
        </div>
        <LoginForm role={role} />
      </motion.div>
